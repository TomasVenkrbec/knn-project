...
def parse_args():
    ...
    argParser.add_argument('--attention_res', dest='attention_res', action='store', type=int, help='Resolution of layer where Self-Attention module is added.')
    argParser.add_argument('--val_batches', dest='val_batches', action='store', type=int, help='Number of batches used for model validation at the end of every epoch.')
